...
struct Booksellers<
    D: Choreography<Located<bool, Buyer1>> + Decider<Budgets = Budgets>,
    Budgets,
    Buyers,
    B1Index,
    BSIndex,
            ...
            fn run(self, op: &impl ChoreoOp<Self::L>) -> Located<Option<NaiveDate>, Buyer1> {
                ...
                if decision {
                    let delivery_date_at_seller = op.locally(Seller, |un| {
                        ...
                        inventory
                            .get(title)
                            .map(|(_, delivery_date)| *delivery_date)
                    });
...
impl Choreography<Located<bool, Buyer1>> for Unilateral {
    ...
    fn run(self, op: &impl ChoreoOp<Self::L>) -> Located<bool, Buyer1> {
        op.locally(Buyer1, |un| match un.unwrap(&self.price) {
...
impl<Buyers: LocationSet, B1Index, BSRefl, BSFld> Decider
    for Colaborative<Buyers, B1Index, BSRefl, BSFld>
where
    Buyer1: Member<Buyers, B1Index>,
...
impl<Buyers: LocationSet, B1Index, BSRefl, BSFld> Choreography<Located<bool, Buyer1>>
    for Colaborative<Buyers, B1Index, BSRefl, BSFld>
where
    Buyer1: Member<Buyers, B1Index>,
    Buyers: Subset<Buyers, BSRefl>,
        ...
        match op.broadcast(Buyer1, self.price) {
            Some(price) => {
                    ...
                    Buyer1: Member<Buyers, B1Index>,
                {
                    ...
                    {
                        op.comm::<_, Q, Buyer1, Money, (QMemberL, _), QMemberL, B1Index>(
                            Q::new(),
                            Buyer1,
...
fn run_test(
    ...
    title: Title,
    budget1: Money,
    budget2: Option<Money>,
    answer: Option<NaiveDate>,
) {
    ...
    if let Some(budget2) = budget2 {
        {
            ...
            let choreo: Booksellers<
                Colaborative<LocationSet!(Buyer1, Buyer2), _, _, _>,
            ...
            > = Booksellers {
                ...
                budgets: central_runner.unsafe_faceted(
                    [
                        (String::from(Buyer1::name()), budget1),
                        (String::from(Buyer2::name()), budget2),
                    ],
                    <LocationSet!(Buyer1, Buyer2)>::new(),
                ),
                _phantoms: PhantomData,
            };
        ...
        }
        {
            handles.push(thread::spawn(move || {
                ...
                > = Booksellers {
                    ...
                    budgets: seller_projector.remote_faceted(<LocationSet!(Buyer1, Buyer2)>::new()),
                    _phantoms: PhantomData,
                };
        ...
        }
        {
            handles.push(thread::spawn(move || {
                ...
                > = Booksellers {
                    ...
                    budgets: buyer1_projector
                        .local_faceted(budget1, <LocationSet!(Buyer1, Buyer2)>::new()),
                    _phantoms: PhantomData,
                };
        ...
        }
        {
            handles.push(thread::spawn(move || {
                ...
                > = Booksellers {
                    ...
                    budgets: buyer2_projector
                        .local_faceted(budget2, <LocationSet!(Buyer1, Buyer2)>::new()),
                    _phantoms: PhantomData,
                };
...
fn main() {
    ...
    run_test(
        ...
        100,
        None,
        Some(NaiveDate::from_ymd_opt(2023, 8, 3).unwrap()),
    );
